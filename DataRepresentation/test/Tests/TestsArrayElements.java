...
public class TestsArrayElements {
    ...
    public ArrayList<TableElement> test1(){
        ...
        //constructor: TableElement("wall", x1,y1,x2,y2,floorNumber,room,isExterior,isExit)
        //Floor exterior walls
        floor.add(new TableElement("wall", 10,27,15,27,1,-1,true,true));
        floor.add(new TableElement("wall", 2,17,2,22,1,-1,true,true));
        ...
        //room 101
        floor.add(new TableElement("wall", 5,11,10,11,1,101,false,true));
        ...
        //room 102
        floor.add(new TableElement("wall", 24,9,24,5,1,101,false,true));
        floor.add(new TableElement("wall", 13,11,24,11,1,101,false,false));
        floor.add(new TableElement("wall", 24,11,24,9,1,101,false,false));
        floor.add(new TableElement("wall", 24,5,24,2,1,101,false,false));
        floor.add(new TableElement("wall", 24,2,13,2,1,101,false,false));
        floor.add(new TableElement("wall", 13,2,13,11,1,101,false,false));

        //room 103
        floor.add(new TableElement("wall", 29,16,32,16,1,101,false,true));
        floor.add(new TableElement("wall", 34,13,34,10,1,101,false,true));
        floor.add(new TableElement("wall", 27,16,29,16,1,101,false,false));
        floor.add(new TableElement("wall", 32,16,34,16,1,101,false,false));
        floor.add(new TableElement("wall", 34,16,34,13,1,101,false,false));
        floor.add(new TableElement("wall", 34,10,34,4,1,101,false,false));
        floor.add(new TableElement("wall", 34,4,27,4,1,101,false,false));
        floor.add(new TableElement("wall", 27,4,27,16,1,101,false,false));
    ...
    public ArrayList<TableElement> test2(){
        ...
        //constructor: TableElement("wall", x1,y1,x2,y2,floorNumber,room,isExterior,isExit)
        //Floor exterior walls
        floor.add(new TableElement("wall", 10,28,15,28,1,-1,true,true));
        floor.add(new TableElement("wall", 2,17,2,22,1,-1,true,true));
        floor.add(new TableElement("wall", 2,27,10,27,1,-1,true,false));
        floor.add(new TableElement("wall", 15,27,24,27,1,-1,true,false));
        floor.add(new TableElement("wall", 24,27,24,18,1,-1,true,false));
